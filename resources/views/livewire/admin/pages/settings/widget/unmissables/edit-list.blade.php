<div class="p-4">
	<div class="space-y-8">
		...
		<div class="grid grid-cols-2 gap-8">
			...
			<div class="space-y-3">
				<x-input wire:model.debounce.500="search_added" type="text" name="search" placeholder="Cerca tra 'Gli Imperdibili'.."></x-input>
				<div class="max-h-96 overflow-y-scroll">
					<x-laravel-blade-sortable::sortable wire:onSortOrderChange="sortUnmissableOrder" as="ul" role="list" class="space-y-3">
						@forelse($unmissables as $brand)
