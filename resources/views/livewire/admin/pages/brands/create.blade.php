            ...
            <div class="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="col-span-full">
                    <div class="flex items-center justify-between">
                        ...
                        @if($logo)
                        <span wire:click="$set('logo', null)" class="text-sm font-semibold text-red-500 hover:cursor-pointer hover:underline">Elimina</span>
                        @endif
                    </div>
                    @if(!$logo)
                    <div class="mt-2 flex justify-center rounded-lg border border-dashed {{ $errors->has('logo') ? 'border-red-500' : 'border-gray-900/25' }} px-6 py-10">
