        ...
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="-mx-4 mt-8 sm:-mx-0">
                <table class="min-w-full divide-y divide-gray-300">
                    <thead>
                    <tr>
                        <th scope="col" class="lg:hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                            Utente
                        </th>
                        <th scope="col"
                            class="hidden py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-3 lg:table-cell">
                            Teyuto ID
                        </th>
                        <th scope="col"
                        ...
                        <th scope="col"
                            class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell">Ruolo
                        </th>
                                ...
                                <dl class="font-normal lg:hidden">
                                    @if($user->teyuto_id)
                                        <p class="mt-1 text-xs text-gray-500">
                                            Teyuto ID: <span class="font-bold">{{ $user->teyuto_id }}</span>
                                        </p>
                                    @endif
