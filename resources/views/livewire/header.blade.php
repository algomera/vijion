				...
				<div class="flex items-center w-full max-w-sm">
					...
					<div x-data="{ open: false }" x-on:click="open = true" class="relative flex items-center space-x-2 h-full rounded-r-full text-sm border border-l-0 border-gray-200 font-semibold text-gray-700 px-3 hover:cursor-pointer">
						...
						<div x-show="open"
						     ...
						     x-on:click.away="open = false" class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-xl overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
