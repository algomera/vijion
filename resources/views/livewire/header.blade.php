<header x-data="{ show: false }" class="bg-white">
    <nav class="container flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12 w-full">
                <div class="flex items-center w-full max-w-sm">
                    <div class="relative flex w-full">
                        <input type="text" name="price" id="price" class="block w-full rounded-l-full py-2.5 pr-7 pr-20 text-gray-900 border border-r-0 border-gray-200 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Cerca su VIJI-STORE..">
                        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="text-gray-700 w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                            </svg>
                        </div>
                    <div class="absolute right-0 top-2.5 w-px h-7 bg-gray-200"></div>
                    </div>
                    <div class="flex items-center space-x-2 h-full rounded-r-full text-sm border border-l-0 border-gray-200 font-semibold text-gray-700 px-3">
                        <span>Categorie</span>
        ...
        <div class="flex lg:hidden">
            <button x-on:click="show = true" type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
        ...
        <div class="hidden lg:flex lg:items-center lg:space-x-3">
            ...
            <a href="#" class="rounded-md bg-white mx-2 py-2.5 px-4 text-xs font-semibold text-brand uppercase ring-1 ring-inset ring-brand hover:bg-brand hover:text-white">Vai su Vijion</a>
        </div>
    </nav>
