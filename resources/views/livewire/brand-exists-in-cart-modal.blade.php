<div class="p-4">
	<div class="flex flex-col items-center space-y-7">
		<div class="text-center">
			<h3 class="text-base font-semibold leading-6 text-gray-900">Nel carrello è già presente un coupon <span
						class="uppercase">{{ $existing->brand->name }}</span></h3>
			<div class="mt-2">
				<p class="text-sm text-gray-500">
					Puoi sostituire il coupon presente nel carrello con questo coupon.
				</p>
			</div>
